...
- [x] Add one non-interactive grain layer across every route
- [x] Widen semantic surface separation in both appearances
...
- [ ] Add cold-entry homepage copy and an immediate Get in action
- [ ] Add a fixed shared public header with Apply beside Sign in
- [ ] Remove timer gating from every homepage application action
- [ ] Verify hit targets, latch sweeps, overflow, routes, and unchanged row counts
