...
const ALL: Record<string, NavDest> = {
  ...
  leaderboard: {
    ...
    icon: Trophy,
    purpose: 'See where you rank this week against everyone else.',
  },
  board: { key: 'board', label: 'Board', path: '/app/leaderboard', icon: Trophy, purpose: 'See where you rank this week against everyone else.' },
  ...
  installs: {
    ...
    path: '/app/installs',
    icon: Wifi,
    purpose: 'Report how many you got in today and check the week.',
  },
  stacks: {
    key: 'stacks',
    label: 'Stacks',
    ...
    icon: DollarSign,
    minTier: 'manager',
    purpose: 'Set what each rep earns per install.',
  },
  pipeline: {
    key: 'pipeline',
    label: 'Pipeline',
    path: '/app/pipeline',
    icon: ClipboardList,
    purpose: 'Move your policies from first call to paid.',
  },
  team: {
    key: 'team',
    label: 'Team',
    ...
    icon: Users,
    minTier: 'manager',
    purpose: 'Your roster, the structure under you, and the war room.',
  },
  ...
  leads: {
    ...
    icon: PhoneCall,
    minTier: 'manager',
    purpose: 'Call the people who asked about a job.',
  },
  forms: {
    key: 'forms',
    label: 'Forms',
    ...
    icon: FileText,
    minTier: 'manager',
    purpose: 'Interviews, weekly one on ones, and the manager meeting.',
  },
  approvals: {
    key: 'approvals',
    label: 'Approvals',
    ...
    icon: Video,
    minTier: 'manager',
    purpose: 'Watch pitch videos and pass or send them back.',
  },
  admin: {
    key: 'admin',
    label: 'Pillar',
    ...
    icon: Shield,
    minTier: 'admin',
    purpose: 'Decisions waiting on you, plus people, money and content.',
  },
  profile: {
    key: 'profile',
    label: 'Profile',
    path: '/app/profile',
    icon: User,
    purpose: 'Your photo, your details and your badges.',
  },
  settings: {
    key: 'settings',
    label: 'Settings',
    path: '/app/settings',
    icon: Wrench,
    purpose: 'How the app looks, what it tells you, and your password.',
  },
  ...
  doors: {
    ...
    path: '/app/doors',
    icon: Home,
    purpose: 'Run a door on your phone, knock by knock.',
  },
  ...
  recruits: {
    ...
    icon: Users,
    minTier: 'manager',
    purpose: 'Track everyone you are trying to sign, stage by stage.',
  },
  industries: {
    key: 'industries',
    label: 'Industries',
    path: '/app/industries',
    icon: Wrench,
    purpose: 'See Pest, Fiber and Life, and ask to join another one.',
  },
