...
const INDUSTRIES = ['PEST CONTROL', 'FIBER INTERNET', 'LIFE INSURANCE'];
...
export function CoverTicker() {
  ...
  return (
    <div className="cover-ticker public-section" aria-label="Trinity offices, team and industries">
