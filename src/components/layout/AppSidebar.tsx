...
import { Home, GraduationCap, Trophy, LogOut, User, Users, Calendar, Mountain, Shield, MessagesSquare, FileText, Link2, ClipboardList } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const managerNavItems: NavItem[] = [
  ...
  { label: 'Training', path: '/app/training', icon: GraduationCap, iconColor: 'text-green-400' },
  { label: 'Chat', path: '/app/chat', icon: MessagesSquare, iconColor: 'text-blue-300' },
  { label: '1:1 Prep', path: '/app/one-on-ones/prep', icon: ClipboardList, iconColor: 'text-cyan-400' },
