...
export function StreakLeaderboard() {
  ...
  if (entries.length === 0) {
    return (
      <div className="p-8 text-center bg-orange-500/5 rounded-xl">
        ...
        <div className="mt-3 text-[10px] text-muted-foreground/60 space-y-0.5">
          ...
          <p>14 days = +700 bonus pts</p>
          <p>30 days = +2,000 bonus pts</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mx-4 mt-4 p-2.5 rounded-lg bg-orange-500/10 border border-primary/15">
        ...
        <div className="grid grid-cols-3 gap-2 px-4">
          {top3.map((entry, index) => {
            ...
            const bgClass = rank === 1
              ? 'bg-amber-500/20 border-primary/30'
              : rank === 2
