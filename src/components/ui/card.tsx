...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[var(--radius)] border border-border/60 bg-card/70 text-card-foreground shadow-[0_10px_30px_-18px_hsl(0_0%_0%/0.8)] backdrop-blur-sm transition-colors duration-200",
      className,
    )}
    {...props}
  />
