      ...
      <div className="glass-card rounded-2xl p-4 mb-4">
        ...
        {sellingThisSummer && (
          <div className="space-y-2.5 mt-3 pt-3 border-t border-border/20">
            <CurrencyInput value={personalRevStr} onChange={setPersonalRevStr} label="Your Gross Revenue Goal" icon={DollarSign} placeholder="e.g. 300,000" <CurrencyInput value={personalRevStr} onChange={setPersonalRevStr} label="Your Gross Revenue Goal" icon={DollarSign} placeholder="e.g. 300,000" hint="Total serviced revenue you plan to sell" /> />
