...
import { Swords, Calculator } from 'lucide-react';
    ...
    <AppLayout>
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="relative h-40 rounded-xl overflow-hidden mb-6">
          <div className="absolute inset-0 bg-gradient-to-r from-teal-500/25 via-emerald-500/15 to-success/20" />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Performance insights and data tools
            </p>
          </div>
        </div>
        ...
        <div className={cn(
          'grid gap-5',
          availableCards.length === 1 ? 'grid-cols-1 max-w-md mx-auto' : 'grid-cols-1 md:grid-cols-2'
        )}>
