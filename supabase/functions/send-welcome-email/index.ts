  ...
  try {
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: `Welcome to Summit, ${firstName}`,
        html: `
          <!DOCTYPE html>
          <html>
          <head>
            ...
            <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
              ...
              <div style="background: #ffffff; border-radius: 16px; padding: 40px; margin-top: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                ...
                <p style="color: #64748b; font-size: 16px; margin: 0 0 20px 0;">
                  Thanks for applying to Summit as a <strong style="color: #3b82f6;">${typeLabel}</strong>. We're excited to learn more about you!
                </p>
